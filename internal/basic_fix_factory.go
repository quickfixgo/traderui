...
//BasicFIXFactory builds vanilla fix messages, implements traderui.fixFactory
type BasicFIXFactory struct{}

func (BasicFIXFactory) NewOrderSingle(order Order) (msg quickfix.Messagable, err error) {
...
func (BasicFIXFactory) OrderCancelRequest(order Order, clOrdID string) (msg quickfix.Messagable, err error) {
	switch order.SessionID.BeginString {
	case enum.BeginStringFIX42:
...
func populateOrder(genMessage quickfix.Messagable, ord Order) (quickfix.Messagable, error) {
...
func nos40(ord Order) (quickfix.Messagable, error) {
	nos := fix40nos.New(
...
func nos41(ord Order) (quickfix.Messagable, error) {
	nos := fix41nos.New(
		field.NewClOrdID(ord.ClOrdID),
		field.NewHandlInst("1"),
		field.NewSymbol(ord.Symbol),
...
func nos42(ord Order) (quickfix.Messagable, error) {
	nos := fix42nos.New(
		field.NewClOrdID(ord.ClOrdID),
		field.NewHandlInst("1"),
		field.NewSymbol(ord.Symbol),
...
func cxl42(ord Order, clOrdID string) (quickfix.Messagable, error) {
	cxl := fix42cxl.New(
...
func nos43(ord Order) (quickfix.Messagable, error) {
	nos := fix43nos.New(
		field.NewClOrdID(ord.ClOrdID),
		field.NewHandlInst("1"),
		field.NewSide(ord.Side),
...
func nos44(ord Order) (quickfix.Messagable, error) {
	nos := fix44nos.New(
		field.NewClOrdID(ord.ClOrdID),
		field.NewSide(ord.Side),
		field.NewTransactTime(time.Now()),
...
func nos50(ord Order) (quickfix.Messagable, error) {
	nos := fix50nos.New(
		field.NewClOrdID(ord.ClOrdID),
		field.NewSide(ord.Side),
		field.NewTransactTime(time.Now()),
